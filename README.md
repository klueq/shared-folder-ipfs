...
We can split the entire set into subsets based on the 1st hash digit. This is the `x` set:

![](diag/x-set-tree/g.png)

Then we compare the subsets and continue this process recursively recursively:
